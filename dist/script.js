...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var form = new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.join__evolution .form');
  form.init();
});
    ...
    value: function render() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          if (_this2.slides[_this2.slideIndex - 2]) {
            _this2.slides[_this2.slideIndex - 2].classList.remove('fadeIn');
          }
        ...
        item.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this2.slides[_this2.slideIndex - 1].classList.remove('fadeIn');
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function activateAnimation(autoplay) {
      var _this3 = this;
    ...
    value: function init() {
      ...
      if (this.autoplay) {
        ...
        this.container.addEventListener('mouseenter', function () {
          _this4.activateAnimation(autoplay, true);
        });
        this.container.addEventListener('mouseleave', function () {
          autoplay = _this4.activateAnimation(autoplay);
        });
      }
    }
  }]);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      slideClass = _ref$slideClass === void 0 ? null : _ref$slideClass,
      _ref$btns = _ref.btns,
